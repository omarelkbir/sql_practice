...
-USE IN FOR SMALL TABLES AND/OR SIMPLE FILTERS, USE EXISTS FOR LARGE TABLES AND/OR
COMPLEX FILTERS
-NOT FOR NOT IN AND NOT EXISTS, HERES THE NULL RISK. IF NOT IN FINDS A SINGLE NULL 
IN ITS RESULT/OUTPUT WHATEVER, IT WILL BREAK. SO PROS TEND TO PREFER NOT EXISTS AS IT 
CAN HANDLE EVERYTHING JUST FINE. EVEN IF NOT IN DOESNT FIND NULLS, OVER A LARGE TABLE
NOT EXISTS SCALES BETTER AND FASTER THAN NOT EXISTS ANYWAY. SO PROS USUALLY AVOID NOT IN
*/
